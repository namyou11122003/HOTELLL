...
<body class="bg-light">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="text-end mb-4">
                            <h5 class="card-title m-0">Add Rooms</h5>
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#edit-rooms-s">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row">
                                    <?php 
                                        ...
                                        {
                                            echo"
                                                <div class='col-mb-3 mb-1'>vvvvvvvvvvvvvvvvvvv
                                                    <label>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="dsc" class="form-control shadow-none" rows="4" required></textarea>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="edit-room" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modallg">
            <form id="edit-room_form" autocomplete="off">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <input type="hedden" name="room_id">
                        </div>    
                    </div>
                    <div class="modal-footer">
                        <button type="reset" class="btn text-secondary shadow-none" data-bs-dismiss="modal">Cancel</button>
            ...
            <div class="modal-body">
                ...
                <div class="border-bottom border-3 pb-3 mb-3">
                    <form id="add_image_form" >
                        <label  class="form-label">Add Imgae</label>
                        <input type="file"  name="image"  accept="[.jpg, .png, .webp, .jpeg]" class="form-control shadow-none mb-3" required >
                        <button class="btn cuistom-bg text-white shadow-none">ADD</button>
                 ...
                 <div class="table-responsive-lg" style="height: 350px; overflow-y: scroll;" >
                    <table class="table tabel-hover broder">
                        <thead class="stiky-top">
                            <tr class="bg-dark text-light stiky-top">
                                <th scope="col" width="60%">Image</th>
                                <th scope="col">Thumb</th>
                                <th scope="col">Delete</th>
                            </tr>
                        </thead>
                        <tbody id="room_image-data">
    ...
    <script src="scripts/rooms."></script>
</body>
</html>